...
def upgrade() -> None:
    ...
    op.drop_constraint('dependency_depends_on_id_fkey', 'dependency', type_='foreignkey')
    op.create_foreign_key('fk_dependency_section_id', 'dependency', 'section', ['section_id'], ['id'])
    op.create_foreign_key('fk_dependency_depends_on_section_id', 'dependency', 'section', ['depends_on_section_id'], ['id'])
    op.create_foreign_key('fk_dependency_depends_on_document_id', 'dependency', 'document', ['depends_on_document_id'], ['id'])
...
def downgrade() -> None:
    ...
    op.drop_constraint('fk_dependency_section_id', 'dependency', type_='foreignkey')
    op.drop_constraint('fk_dependency_depends_on_section_id', 'dependency', type_='foreignkey')
    op.drop_constraint('fk_dependency_depends_on_document_id', 'dependency', type_='foreignkey')
    op.create_foreign_key('dependency_depends_on_id_fkey', 'dependency', 'document', ['depends_on_id'], ['id'])
